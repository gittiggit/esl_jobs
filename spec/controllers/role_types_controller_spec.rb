...
RSpec.describe RoleTypesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested role_type as @role_type" do
      role_type = RoleType.create! valid_attributes
      get :show, {:id => role_type.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested role_type as @role_type" do
      role_type = RoleType.create! valid_attributes
      get :edit, {:id => role_type.to_param}, valid_session
      expect(assigns(:role_type)).to eq(role_type)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new RoleType" do
        expect {
          post :create, {:role_type => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved role_type as @role_type" do
        post :create, {:role_type => invalid_attributes}, valid_session
        expect(assigns(:role_type)).to be_a_new(RoleType)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested role_type" do
        role_type = RoleType.create! valid_attributes
        put :update, {:id => role_type.to_param, :role_type => new_attributes}, valid_session
        role_type.reload
      ...
      it "assigns the requested role_type as @role_type" do
        role_type = RoleType.create! valid_attributes
        put :update, {:id => role_type.to_param, :role_type => valid_attributes}, valid_session
        expect(assigns(:role_type)).to eq(role_type)
      end
    ...
    context "with invalid params" do
      it "assigns the role_type as @role_type" do
        role_type = RoleType.create! valid_attributes
        put :update, {:id => role_type.to_param, :role_type => invalid_attributes}, valid_session
        expect(assigns(:role_type)).to eq(role_type)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested role_type" do
      role_type = RoleType.create! valid_attributes
      expect {
        delete :destroy, {:id => role_type.to_param}, valid_session
      }.to change(RoleType, :count).by(-1)
    end
